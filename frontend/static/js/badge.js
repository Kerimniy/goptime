      ...
      let badgSVG = `
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="130" height="20" role="img" aria-label="h24uptime">
            ...
            <g clip-path="url(#r)">
                ...
                <rect x="77" width="50" height="20" fill=${p2rgb(uptime/100)}>
            ...
            <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
                ...
                <text aria-hidden="true" x="1000" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)">${uptime}%</text>
                <text x="1000" y="140" transform="scale(.1)" fill="#fff" >${uptime}%</text>
            </g>
        </svg>
